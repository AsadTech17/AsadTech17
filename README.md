...
| Project | Description |
|---------|-------------|
|  [Multi Vendor eCommerce App]((https://github.com/AsadTech17/E_SHOP_Project)) | A full MERN-stack real estate platform featuring property listings, user authentication, and CRUD operations. Includes modern UI built with React & Bootstrap, a secure Express-based backend, and a MongoDB database. |
